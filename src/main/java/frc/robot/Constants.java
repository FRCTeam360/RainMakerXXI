...
public final class Constants {
    ...
    public static final class SlalomRunTrajectories {
        ...
        public static final Trajectory slalomPath = TrajectoryGenerator.generateTrajectory( //v=4 a=5
            new Pose2d(0, 0, new Rotation2d(0)), 
            List.of( 
                new Translation2d(1.448, 0.575),
                new Translation2d(2.211 -0.200, 1.727),
                new Translation2d(5.941 -0.175 -0.650 + 0.100, 1.727),
                //new Translation2d(6.783, 0.457), //6.595, 0.741 (old val tangent)
                new Translation2d(7.124 -0.650, 0.056 -0.150), //7.124, 0.457
                ...
                new Translation2d(5.941 +0.900, 0.457 -.2 -0.150), //slight adjustment to avoid hitting a ball
                new Translation2d(2.211 -0.300, 0.457),
                new Translation2d(1.369 + .5, 1.727) //point right before finishing line in theory
             ),
