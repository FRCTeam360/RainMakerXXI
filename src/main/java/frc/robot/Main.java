...
public final class Main {
  private Main() {    //Main initialization function. Do not perform any initialization here.
  }

  public static void main(String... args) {    //If you change your main robot class, change the parameter type.
